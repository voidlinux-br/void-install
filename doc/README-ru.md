...
Установщик сообщества VoidBR для VOID Linux, ориентированный на практичность, автоматизацию и современный опыт установки.
...
Запустите локально без установки:
