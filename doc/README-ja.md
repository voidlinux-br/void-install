...
VOID Linux 用の VoidBR コミュニティ インストーラーは、実用性、自動化、最新のインストール エクスペリエンスに重点を置いています。

---

# インストール

## 方法 1 — VoidBR リポジトリ (推奨)

公式 Void Linux ISO を使用する:
...
## Método 4 — マニュアルの do スクリプトをダウンロードする
...
> システムのインストールを実行するには、「sudo」または高い権限が必要です。
