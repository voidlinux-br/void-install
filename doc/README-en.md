...
VoidBR community installer for VOID Linux, focused on practicality, automation and modern installation experience.

---

# Installation

## Method 1 — VoidBR Repositories (recommended)

Using the official Void Linux ISO:
...
## Method 3 — Quick installation via curl/wget
...
> `sudo` or elevated privileges are required to perform the system installation.
